...
domain_name         = "agentage.io"            # Primary production domain
...
server_name = "agentage-prod"
server_type = "cx43"           # 16GB RAM, 8 vCPUs (~€35/month)
...
ssh_public_key = "ssh-rsa AAAAB3NzaC1yc2EAAA... prod@agentage.io"
...
traefik_host       = "traefik.agentage.io"
swarmpit_host      = "swarmpit.agentage.io"
dozzle_host        = "logs.agentage.io"
traefik_acme_email = "admin@agentage.io"     # Valid email for SSL notifications
...
#
# 5. Cost Management:
#    ✓ Review server size (CX43 ~€35/month)
