# =============================================================================
# 🌐 AGENTAGE.IO TERRAFORM CONFIGURATION TEMPLATE
# =============================================================================
# 
# This is an example configuration file for deploying agentage.io infrastructure.
...
# Examples:
#   - Production: "agentage.io"
#   - Development: "dev.agentage.io" 
#   - Staging: "staging.agentage.io"
...
#   3. Give it a descriptive name (e.g., "agentage-terraform")
...
#   4. Give it a descriptive name (e.g., "agentage-terraform")
#   5. Set permissions: Read & Write for all resources
#   6. Copy the generated token
hetzner_token = "YOUR_HETZNER_CLOUD_API_TOKEN"

# Server configuration
server_name = "agentage-server"       # Server hostname in Hetzner Cloud
...
#      ssh-keygen -t rsa -b 4096 -C "your-email@domain.com" -f ~/.ssh/agentage_rsa
#   2. Copy the PUBLIC key content:
#      cat ~/.ssh/agentage_rsa.pub
...
# - Issues: https://github.com/agentage/infrastructure/issues
#
# =============================================================================
